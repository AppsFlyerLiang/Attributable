...
class _ConversionState extends State<Conversion> {
  ...
  String _appVersion;
  String _sdkVersion;
  Map<String, String> _installReferrer;
  @override
  void initState() {
    super.initState();
    ...
    AppConfig.installReferrer.then((value) =>
    {
      setState(() {
        _installReferrer = value;
      })
    });
  }
  @override
  Widget build(BuildContext context) {
    ...
    print("[Conversion] build \n$appData");
    print("[Conversion] appData.hashCode: ${appData.hashCode}");
    print("[Conversion] appOpenAttributionData.type. ${appData.appOpenAttributionData?.type}");
    print("[Conversion] Global appData.hashCode: ${AppConfig.appData.appOpenAttributionData.hashCode}");
    print("[Conversion] Global appOpenAttributionData.type ${AppConfig.appData.appOpenAttributionData?.type}");
    print("[Conversion] AppConfig.appOpenAttributionData.hashCode ${AppConfig.appOpenAttributionData.hashCode}");
    print("[Conversion] AppConfig.appOpenAttributionData.type. ${AppConfig.appOpenAttributionData?.type}");
          ...
          child: Padding(
            ...
            child: RichText(
              text: TextSpan(
                ...
                children: [
                  _installReferrer!=null ?
                  _buildParameters(_installReferrer, textStyleKey, textStyleValue)
